...
import org.firstinspires.ftc.teamcode.math_utils.MathUtil;
...
public class PIDFController extends Controller {
    ...
    protected double calculateOutput(double pv) {
        ...
        totalError = MathUtil.clamp(totalError, integrationControl.getMinIntegral(), integrationControl.getMaxIntegral());
